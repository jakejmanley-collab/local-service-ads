    ...
    <main className="min-h-screen bg-slate-50 text-slate-900 font-sans">
      ...
      <section id="pricing" className="py-24 bg-slate-50 text-center">
        <div className="max-w-6xl mx-auto px-6">
          ...
          {/* Upgraded Flyer Package Section */}
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-blue-50 to-white rounded-3xl p-10 border border-blue-100 shadow-md text-center relative overflow-hidden mb-24">
            <div className="absolute top-0 right-0 bg-blue-600 text-white px-6 py-2 rounded-bl-2xl font-bold text-sm">BEST VALUE</div>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="https://buy.stripe.com/aFa28l6uL2WY11G3Tt" className="bg-blue-600 text-white px-10 py-4 rounded-xl font-bold hover:bg-blue-700 transition shadow-lg">Buy Flyer Package ($25)</Link>
              <Link href="/upgrade-offer" className="bg-white text-blue-600 border-2 border-blue-600 px-10 py-4 rounded-xl font-bold hover:bg-blue-50 transition">Get for Free (Yearly)</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-900 text-white py-20">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 italic text-balance">Trusted by Hard-Working Local Pros</h2>
